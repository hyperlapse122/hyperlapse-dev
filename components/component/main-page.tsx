  ...
  return (
    <div key="1" className="flex flex-col min-h-[100dvh]">
      <header className="px-4 lg:px-6 py-6 md:py-12 bg-gradient-to-r from-gray-900 to-gray-800">
        <div className="container grid items-start gap-6 md:gap-4 lg:grid-cols-[1fr_auto] lg:justify-between lg:items-center xl:gap-8 xl:max-w-5xl xl:grid-cols-2">
          <div className="flex flex-col gap-2 lg:order-last">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl text-white">Hi, I&apos;m Sarah!</h1>
            <p className="text-base text-gray-500 md:text-xl dark:text-gray-400">
              Passionate about building robust applications with .NET. I believe in elegant code and beautiful user
              experiences.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-5xl items-center gap-4 lg:gap-8">
            <div className="space-y-2">
              ...
              <p className="max-w-[750px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                I have years of experience working with .NET technologies, including C#, ASP.NET, and Blazor. I&apos;m
                proficient in building scalable and secure applications, and I&apos;m always eager to learn new technologies.
              </p>
            </div>
            <div className="flex flex-col gap-4">
              <div className="grid lg:grid-cols-3 gap-8">
                <Card>
                  ...
                  <CardContent className="p-4">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      The primary language for .NET development. I&apos;m comfortable with everything from language features
                ...
                <Card>
                  ...
                  <CardContent className="p-4">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      My go-to framework for building web applications. I&apos;ve worked on both MVC and Web API projects,
                      and I&apos;m proficient in creating RESTful services and web applications.
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent className="p-4">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      I&apos;m excited about the possibilities of Blazor for building interactive web UIs with C#. I&apos;ve
                      experimented with Blazor WebAssembly and server-side Blazor, and I&apos;m eager to incorporate Blazor
          ...
          <div className="mx-auto w-full max-w-4xl grid gap-4 md:grid-cols-3">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  Description of the project goes here. This project involved building a web application using ASP.NET
                  Core and Angular.
                </CardDescription>
              </CardHeader>
              <CardContent className="p-4">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 border-t">
        <div className="container grid items-center gap-4 px-4 md:px-6">
          <div className="space-y-3">
            ...
            <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              If you&apos;d like to collaborate on a project or have any questions, feel free to send me a message using the
              form below.
            </p>
          </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 Sarah Johnson. All rights reserved.</p>
